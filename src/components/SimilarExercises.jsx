  ...
  return (
    <Box sx={{ mt: { lg: '100px', xs: '0px' } }}>
        ...
        <Typography sx={{ fontSize: { lg: '44px', xs: '25px' }, ml: '20px' }} fontWeight={700} color="#fff" mb="33px">
          Similar <span style={{ color: '#4db5ff', textTransform: 'capitalize' }}>Target Muscle</span> exercises
        </Typography>
        ...
        <Typography sx={{ fontSize: { lg: '44px', xs: '25px' }, ml: '20px', mt: { lg: '100px', xs: '60px' } }} fontWeight={700} color="#fff" mb="33px">
          Similar <span style={{ color: '#4db5ff', textTransform: 'capitalize' }}>Equipment</span> exercises
        </Typography>
